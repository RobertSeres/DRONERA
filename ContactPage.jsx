...
function ContactPage() {
  ...
  const [isSubmitting, setIsSubmitting] = useCState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("access_key", "03c5d12c-c634-409b-ab49-0b92a97a9e8e");
  ...
  return (
    <div ref={containerRef}>
      ...
      <section style={{
        ...
        {/* Corner bracket */}
        <svg style={{
          position: "absolute", top: "80px", right: "clamp(24px,5vw,80px)",
          width: "72px", height: "72px", opacity: 0.12, pointerEvents: "none"
          ...
          <div>
            ...
            {[
              ...
              },
              {
                ...
                label: "Telefon", val: "+36 20 342 4132"
              },
              {
              ...
              <div key={label} className="cp-form-elem" style={{ display: "flex", alignItems: "flex-start", gap: "20px", marginBottom: "36px", opacity: 0 }}>
                ...
                <div>
                  <p style={{
                    ...
                    textTransform: "uppercase", letterSpacing: "0.15em", color: "rgba(0,0,0,0.32)", marginBottom: "8px"
                  }}>{label}</p>
          ...
          <div className="cp-form-elem" style={{ opacity: 0 }}>
            {submitted ? (
              <div style={{
                ...
                <div style={{
                  fontFamily: "'Tanker',sans-serif", fontSize: "clamp(36px,5vw,52px)",
                  textTransform: "uppercase", color: "#0D0D0D", marginBottom: "16px"
                }}>Köszönjük.</div>
                <p style={{
